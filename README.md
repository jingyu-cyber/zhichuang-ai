...
### 🧑‍🎓 学生端 — 成长规划与能力画像
![学生成长规划](docs/screenshots/screenshot-student-v2.png)

学生通过代码提交触发智能分析，系统自动提取5类能力信号、生成80分多维评分报告（功能完成度83/代码结构82/工程规范79/测试意识71/文档表达83），追踪5条证据片段，定位1条改进任务。

### 👨‍🏫 教师端 — 项目分析与班级诊断
![教师看板](docs/screenshots/screenshot-teacher-full.png)

教师可查看全班学生的项目分析报告、能力分布热力图、学情诊断和梯队筛选结果，实现数据驱动的精准教学决策。

### 🛠️ 管理端 — 知识库资料管理
![知识库问答](docs/screenshots/screenshot-admin-full.png)
